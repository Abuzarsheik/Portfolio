...
const About = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-32" id="about">
      ...
      >
        {/* Section Title */}
        <motion.h2 variants={itemVariants} className="numbered-heading">
          About Me
        </motion.h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            <motion.div variants={itemVariants} className="space-y-4">
              <p className="text-slate text-lg leading-relaxed">
                Hello! I'm Abuzar, a passionate software engineer who enjoys
                ...
                custom themes — turns out hacking together a custom website
                taught me a lot about HTML & CSS!
              </p>

              <p className="text-slate text-lg leading-relaxed">
                Fast-forward to today, and I've had the privilege of working on
                various projects ranging from blockchain-based e-commerce
                platforms to real-time chat applications. My main focus these
                days is building accessible, inclusive products and digital
                experiences using modern web technologies.
              </p>

              <p className="text-slate text-lg leading-relaxed">
                I recently graduated with a degree in Information Technology and have
                been working on improving my skills in full-stack development,
                ...
                <div className="relative rounded-lg overflow-hidden">
                  <div className="bg-green bg-opacity-20 w-full h-80 rounded-lg flex items-center justify-center">
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-light-navy to-lightest-navy rounded-lg flex items-center justify-center">
                      <span className="text-6xl text-green font-mono font-bold">
                        AS
                      </span>
                    </div>
                  </div>
