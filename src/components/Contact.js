        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-secondary">Follow Me</h3>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className={`w-12 h-12 bg-white rounded-lg shadow-md border flex items-center justify-center text-gray-600 ${social.color} transition-all duration-200 hover:shadow-lg hover:-translate-y-1`}
                    title={social.name}
                  >
                    {social.icon}
                  </a>
